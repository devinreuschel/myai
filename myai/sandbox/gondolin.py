...
def _append_common_flags(
    ...
    *,
    ...
    allow_hosts = provision_allow_hosts(cfg) if provision else effective_allow_hosts(cfg)
...
def register_session(repo: Path, session_id: str, resume_id: str | None = None) -> None:
    save_session(
        RepoSession(
